...
\- \[Problem Summaries](#problem-summaries)
...
g++ -std=c++17 -O2 bit\_strings.cpp
...
| Weird Algorithm | Simulation | \[View](summaries/weird\_algorithm.md) |

| Missing Number | Mathematics | \[View](summaries/missing\_number.md) |

| Repetitions | Linear Traversal | \[View](summaries/repetitions.md) |

| Increasing Array | Greedy | \[View](summaries/increasing\_array.md) |

| Permutations | Constructive Algorithm | \[View](summaries/permutations.md) |

| Number Spiral | Mathematics | \[View](summaries/number\_spiral.md) |

| Two Knights | Combinatorics | \[View](summaries/two\_knights.md) |

| Two Sets | Constructive Algorithm | \[View](summaries/two\_sets.md) |

| Bit Strings | Combinatorics | \[View](summaries/bit\_strings.md) |

| Trailing Zeros | Number Theory | \[View](summaries/trailing\_zeros.md) |

| Coin Piles | Mathematical Observation | \[View](summaries/coin\_piles.md) |

| Palindrome Reorder | Frequency Counting | \[View](summaries/palindrome\_reorder.md) |

| Gray Code | Constructive Algorithm | \[View](summaries/gray\_code.md) |

| Tower of Hanoi | Recursion | \[View](summaries/tower\_of\_hanoi.md) |

| Creating Strings | Backtracking | \[View](summaries/creating\_strings.md) |

| Apple Division | Backtracking | \[View](summaries/apple\_division.md) |

| Chessboard and Queens | Backtracking | \[View](summaries/chessboard\_and\_queens.md) |

| Digit Queries | Mathematical Observation | \[View](summaries/digit\_queries.md) |

| String Reorder | Greedy | \[View](summaries/string\_reorder.md) |

| Grid Coloring I | Greedy | \[View](summaries/grid\_coloring\_I.md) |

| Mex Grid Construction | Constructive Algorithm | \[View](summaries/mex\_grid\_construction.md) |

| Knight Moves Grid | Breadth-First Search (BFS) | \[View](summaries/knight\_moves\_grid.md) |

| Raab Game I | Constructive Algorithm | \[View](summaries/raab\_game\_I.md) |

| Grid Paths Description | Backtracking | \[View](summaries/grid\_paths\_description.md) |
